...
public class gameYes 
{
	...
	{
		System.out.println("");
		System.out.println("Portal is the one thing you seriously enjoy out of all your games. By far your favorite character is GLaDOS. You "
		+ "always play it because you can never\nget enough of her smooth, emotionless, heavily computer automated voice.");
		System.out.println("");
		System.out.println("<<< GO BACK (1)");
		System.out.println("");
	...
	public static void nintendoTown()
	{
		...
		+ " inspirational qualities, nothing else can really be said. Nintendo is G.");
		System.out.println("");
		System.out.println("<<< GO BACK (1)");
		System.out.println("");
	...
	public static void vrJunction()
	{
		...
		+ "to observe any place that exists on planet earth. The reason why computers call it VR Junction is because of the fact that like "
		+ "whenever humans experience VR, the only thing computers can think of when traveling through the junction is how insanely realistic"
		+ " it looks. But unlike in the real world, you dont have to pay over two grand to experience it");
		System.out.println("");
		System.out.println("<<< GO BACK (1)");
		System.out.println("");
